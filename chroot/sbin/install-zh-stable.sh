...
create-dgl-directories() {
	...
	mkdir -p "$CHROOT/dgldir/inprogress/crawl-$short_version-zh-sprint/"
	mkdir -p "$CHROOT/dgldir/inprogress/crawl-$short_version-zh-tut/"
	mkdir -p "$CHROOT/dgldir/inprogress/crawl-$short_version-zh-zotdef/"
	mkdir -p "$CHROOT/dgldir/inprogress/crawl-$short_version-zh/"
	mkdir -p "$CHROOT/dgldir/rcfiles/crawl-0.$short_version-zh/"
	mkdir -p "$CHROOT/dgldir/data/crawl-0.$short_version-zh-settings/"
}
